    ...
    <section class="error-404 not-found">
        <div class=" min-h-full py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8 my-auto">
            <div class="max-w-max mx-auto">
                <main class="sm:flex">
                    <div class="mt-[88px] lg:mb-2">
                        <p class="text-primary text-center text-[150px] font-black leading-none lg:leading-[142px]">404</p>

                    </div>
                    <div class="mt-2">
                        <div class="sm:border-l sm:border-gray-200 sm:pl-6">
                            <h1 class="h2 text-center text-black leading-[52px] lg:mb-1"><?php esc_html_e('Ops! Essa página não pode ser encontrada.', 'default_theme'); ?></h1>
                            <p class="text-center"><?php esc_html_e('Parece que nada foi encontrado neste local. Talvez tentar uma pesquisa?', 'default_theme'); ?></p>
